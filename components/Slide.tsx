...
const Slide = () => {
  ...
  return (
    <div className="relative flex items-center overflow-hidden mx-auto max-w-7xl overflow-x-hidden p-4">
      {/* <MdChevronLeft
      className='opacity-50 cursor-pointer hover:opacity-100' 
      onClick={sliderLeft} size={40}/> */}
      <div id='HomeSlide' className='w-full h-[240px] overflow-y-hidden overflow-x-scroll whitespace-nowrap scroll-smooth'>
        {data.map((item) => (
