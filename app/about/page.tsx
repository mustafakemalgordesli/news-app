    ...
    <div>
      <div>
        <Image
          ...
          height={200}
          alt=''
          className='max-w-screen-lg mx-auto w-full relative'
        />
      </div> 
      <div className='flex-row flex max-w-screen-lg mx-auto w-full gap-10'>
        ...
        <div className='max-w-screen-lg mx-auto w-full flex flex-col flex-1 mt-30 gap-8 mt-10'>
          <h1 className='text-lg font-bold'>Adresimiz</h1>
          <p className='text-lg font-normal text-justify'>Huzur Mah. Azerbaycan Cad. No:4, 34415 Skyland Rezidans, Sarıyer / İstanbul</p>
        </div>
      </div>
      
      <form className='max-w-screen-lg mx-auto w-full mt-10 border-2 p-2'>
        <div className='text-lg font-bold pb-5'>Bize Ulaşın</div>
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
          <div className="relative z-0 w-full mb-6 group">
              ...
              <label className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Telefon Numarası (5XX-XXX-XXXX)</label>
          </div>
          <div className="relative z-0 w-full mb-6 group">
              <input type="text" name="floating_company" id="floating_company" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
              <label className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Şirket (Ör. Google)</label>
          </div>
        </div>
        <div className="relative z-0 w-full mb-6 group">
